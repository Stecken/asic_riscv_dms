...
module tb_riscv;
    ...
    initial begin
        ...
        // addi x1, x0, 5   → x1 = 5
        dut.dp.mem.mem[0] = 32'h00500093;
        // addi x2, x0, 3   → x2 = 3
        dut.dp.mem.mem[1] = 32'h00300113;
        // add  x3, x1, x2  → x3 = 8
        dut.dp.mem.mem[2] = 32'h002081B3;
        // sw   x3, 0(x0)   → salva x3 na memória[0]
        dut.dp.mem.mem[3] = 32'h00302023;
        // lw   x4, 0(x0)   → x4 = memória[0]
        dut.dp.mem.mem[4] = 32'h00002203;
        // beq  x3, x4, -4  → se x3==x4 volta 1 instrução
        dut.dp.mem.mem[5] = 32'hFE418CE3;
        // jal  x0, 0       → loop infinito
        dut.dp.mem.mem[6] = 32'h0000006F;
